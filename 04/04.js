document.addEventListener ('DOMContentLoaded', () => {
    ...
    const bt1Txt = document.createTextNode('버튼1');
    const bt2Txt = document.createTextNode('버튼2');
    const bt3Txt = document.createTextNode('버튼3');
    const bt4Txt = document.createTextNode('버튼4');
    const bt5Txt = document.createTextNode('버튼5');
    const bt6Txt = document.createTextNode('버튼6');
